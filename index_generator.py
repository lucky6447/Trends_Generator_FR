...
.tc-date-navigation-scroll{display:flex;gap:8px;overflow-x:auto;overflow-y:hidden;scrollbar-width:thin;padding:2px 2px 5px;-webkit-overflow-scrolling:touch}
