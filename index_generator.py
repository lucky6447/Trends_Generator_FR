...
.tc-date-navigation-row{display:flex;flex-wrap:nowrap;align-items:center;gap:8px;overflow-x:auto;overflow-y:hidden;scrollbar-width:thin;padding:2px 2px 5px;-webkit-overflow-scrolling:touch}
.tc-date-navigation-scroll{display:contents}
...
@media(max-width:768px){
  ...
  .tc-date-navigation-row{flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden;scrollbar-width:thin;-webkit-overflow-scrolling:touch}
